...
import { MysqlDatabaseComponent } from 'app/entities/mysqlParser/mysql-database/mysql-database.component';
...
describe('Component Tests', () => {
    describe('MysqlDatabase Management Component', () => {
        let comp: MysqlDatabaseComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [MysqlDatabaseComponent],
                providers: [
                    {
                ...
                .overrideTemplate(MysqlDatabaseComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.mysqlDatabases[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
